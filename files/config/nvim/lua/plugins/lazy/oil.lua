...
return {
	...
	keys = {
		...
		genTulipKeymapsFromEnvNameToPath("gap", "TULIP_GO_APIGATEWAY_PATH_FROM_ROOT"),
		...
		genTulipKeymapsFromEnvNameToPath("ge", "TULIP_GO_EDGELOGGER_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("ginc", "TULIP_GO_INCIDENTTRACKER_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("ginge", "TULIP_GO_INGESTER_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gingr", "TULIP_GO_INGRESSADJUSTER_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gins", "TULIP_GO_INSTANCEMETADATA_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gl", "TULIP_GO_LIMITING_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gmi", "TULIP_GO_MIGRATIONS_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gmo", "TULIP_GO_MODELS_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("gra", "TULIP_GO_RABBITAUTH_PATH_FROM_ROOT"),
		...
		genTulipKeymapsFromEnvNameToPath("gtra", "TULIP_GO_TRANSCODER_PATH_FROM_ROOT"),
		...
		genTulipKeymapsFromEnvNameToPath("ta", "TULIP_TS_AUTOMATIONSAPI_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("tb", "TULIP_TS_BARN_TRAINSTATION_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("tc", "TULIP_TS_CONNECTORREPO_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("te", "TULIP_TS_EMAIL_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("tim", "TULIP_TS_IMPORT_EXPORT_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("til", "TULIP_TS_INTERNALLIBRARY_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("tm", "TULIP_TS_MIGRATIONS_PATH_FROM_ROOT"),
		genTulipKeymapsFromEnvNameToPath("two", "TULIP_TS_WORKFLOWS_PATH_FROM_ROOT"),
		...
		genTulipKeymapsFromEnvNameToPath("ch", "TULIP_CONNECTOR_HOST_PATH_FROM_ROOT"),
	},
}
