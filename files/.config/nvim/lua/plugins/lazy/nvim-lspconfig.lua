...
local M = {
	...
	dependencies = {
		...
		-- The nvim_cmp performance was horrible with typescript-tools
		-- So I changed to vtsls, which resulted in OOM crashes, so It'm trying
		-- yioneko/nvim-vtsls first before jumping into the rabbithole.
...
function M.config()
	...
	require("mason-lspconfig").setup_handlers({
		...
		["vtsls"] = function()
			...
			-- This configuration resulted in numerous crashes, out of memory issues
