...
function M.snippet_to_file(ft, snippet)
  ...
  local file, err = io.open(
    "/home/adamtajti/GitHub/dotfiles/files/snippets/luasnippets/lua/lua.lua",
    "w"
  )
...
function M.setup()
  ...
  vim.api.nvim_set_keymap("n", "<Leader>Du", "", {
    ...
    callback = function()
      ...
      vim.fn.jobstart(
        home_dir .. "/GitHub/dotfiles/installers/_update-system.sh",
        {
  ...
  vim.api.nvim_set_keymap("n", "<Leader>Dl", "", {
    ...
    callback = function()
      print(
        "TODO: Reimplement that installation script, find where it was deleted"
      )
    end,
  })
  ...
  vim.api.nvim_set_keymap("v", "<Leader>Ss", "", {
    ...
    callback = function()
      ...
      local snippet = M.selection_to_snippet(
