...
# Docs is awful in dark mode, the text remains dark on a dark background, and that is painful for the eyes.
config.set("colors.webpage.darkmode.enabled", False, "https://docs.google.com")

# An example how qt args could be set from config
...
## Type: Dict
c.aliases = {
    "wd": "session-save --only-active-window dev",
    "wp": "session-save --only-active-window personal",
    "ed": "session-load dev",
    "ep": "session-load personal",
    "q": "close",
    "qa": "quit",
}
...
## Type: Bool
# note: Set it to false, cause it annoyed me sometimes
...
## Type: QssColor
# c.colors.completion.category.bg = 'qlineargradient(x1:0, y1:0, x2:0, y2:1, stop:0 #000000ff, stop:1 #000000ff)'
...
## Type: QssColor
# c.colors.completion.even.bg = '#080808ff'
...
## Type: QssColor
# c.colors.completion.item.selected.bg = '#79dac8ff'

## Bottom border color of the selected completion item.
## Type: QssColor
# c.colors.completion.item.selected.border.bottom = '#ffffffff'

## Top border color of the selected completion item.
## Type: QssColor
# c.colors.completion.item.selected.border.top = '#080808ff'
...
## Type: QtColor
# c.colors.completion.item.selected.match.fg = '#ff5189ff'

## Foreground color of the matched text in the completion.
## Type: QtColor
# c.colors.completion.match.fg = '#ff5189ff'

## Background color of the completion widget for odd rows.
## Type: QssColor
# c.colors.completion.odd.bg = '#080808ff'
...
## Type: QssColor
# c.colors.tabs.bar.bg = '#080808ff' #080808

## Background color of unselected even tabs.
## Type: QtColor
# c.colors.tabs.even.bg = '#080808ff' #080808

## Background color of unselected odd tabs.
## Type: QtColor
# c.colors.tabs.odd.bg = '#080808ff' #080808

## Foreground color of unselected even tabs.
## Type: QtColor
# c.colors.tabs.even.fg = '#ffffffff' #ffffff

## Foreground color of unselected odd tabs.
## Type: QtColor
# c.colors.tabs.odd.fg = '#ffffffff' #ffffff

## Background color of selected even tabs.
## Type: QtColor
# c.colors.tabs.selected.even.bg = '#080808ff'

## Background color of selected odd tabs.
## Type: QtColor
# c.colors.tabs.selected.odd.bg = '#080808ff'
...
## Type: QtColor
# c.colors.tabs.indicator.error = '#ff5189ff' #ff5189

## Color gradient start for the tab indicator.
## Type: QtColor
# c.colors.tabs.indicator.start = '#36c692ff' #36c692
...
c.content.blocking.adblock.lists = [
    ...
    #'https://easylist.to/easylist/easylist_noadult.txt'
...
# c.content.headers.user_agent = "Mozilla/5.0 ({os_info}) AppleWebKit/{webkit_version} (KHTML, like Gecko) {upstream_browser_key}/137.0.0.0 Safari/{webkit_version}"
...
## Type: Font
c.fonts.tabs.selected = "bold 12pt default_family"
...
## Type: Font
c.fonts.tooltip = "14pt default_family"
...
## Type: Padding
c.tabs.padding = {"top": 5, "bottom": 5, "left": 10, "right": 5}
...
c.url.searchengines = {
    ...
    # "DEFAULT": "http://localhost:23111/search?q={}"
    # "DEFAULT": "https://searxng.site/searxng/search?q={}&language=auto&time_range=&safesearch=2&categories=general",
}
...
config.bind(",r", "greasemonkey-reload --quiet;; reload")
# config.bind('sf', 'save')
...
config.bind(
    "'r",
    "open -t https://www.reddit.com/r/askhungary/new/;;open -t https://www.reddit.com/r/tanulommagam/new/;;open -t https://www.reddit.com/r/hungary_pszichologia/new/",
)
...
moonblue = "#80a0ff"
moonsky = "#74b2ff"
moonturquoise = "#79dac8"
moonpurple = "#ae81ff"
mooncranberry = "#e65e72"
moonviolet = "#cf87e8"
mooncrimson = "#ff5189"
moonred = "#ff5454"
moonspring = "#00875f"
...
# Text color of the completion widget. May be a single color to use for
# all columns or a list of three colors, one for each column.
c.colors.completion.fg = moongreyc

# Background color of the completion widget for odd rows.
c.colors.completion.odd.bg = moonbg

# Background color of the completion widget for even rows.
c.colors.completion.even.bg = moonbg

# Foreground color of completion widget category headers.
c.colors.completion.category.fg = moonlime

# Background color of the completion widget category headers.
c.colors.completion.category.bg = moonbg

# Top border color of the completion widget category headers.
c.colors.completion.category.border.top = moonbg

# Bottom border color of the completion widget category headers.
c.colors.completion.category.border.bottom = moonbg

# Foreground color of the selected completion item.
c.colors.completion.item.selected.fg = moonlime

# Background color of the selected completion item.
c.colors.completion.item.selected.bg = moongreyo

# Top border color of the selected completion item.
c.colors.completion.item.selected.border.top = moongreyo

# Bottom border color of the selected completion item.
c.colors.completion.item.selected.border.bottom = moongreyo
...
# Color of the scrollbar handle in the completion view.
c.colors.completion.scrollbar.fg = moongreyc

# Color of the scrollbar in the completion view.
c.colors.completion.scrollbar.bg = moonbg

# Background color of disabled items in the context menu.
c.colors.contextmenu.disabled.bg = moongreyo

# Foreground color of disabled items in the context menu.
c.colors.contextmenu.disabled.fg = moongreyd

# Background color of the context menu. If set to null, the Qt default is used.
c.colors.contextmenu.menu.bg = moonbg

# Foreground color of the context menu. If set to null, the Qt default is used.
c.colors.contextmenu.menu.fg = moongreyc

# Background color of the context menu’s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.bg = moongreyo

# Foreground color of the context menu’s selected item. If set to null, the Qt default is used.
c.colors.contextmenu.selected.fg = moongreyc

# Background color for the download bar.
c.colors.downloads.bar.bg = moonbg

# Color gradient start for download text.
c.colors.downloads.start.fg = moonbg

# Color gradient start for download backgrounds.
c.colors.downloads.start.bg = base0D

# Color gradient end for download text.
c.colors.downloads.stop.fg = moonbg

# Color gradient stop for download backgrounds.
c.colors.downloads.stop.bg = base0C

# Foreground color for downloads with errors.
c.colors.downloads.error.fg = moonred

# Font color for hints.
c.colors.hints.fg = moonbg

# Background color for hints. Note that you can use a `rgba(...)` value
# for transparency.
c.colors.hints.bg = moonlime

# Font color for the matched part of hints.
c.colors.hints.match.fg = moongreyc

## CSS border value for hints.
## Type: String
c.hints.border = f"1px solid {moonlime}"

# Text color for the keyhint widget.
c.colors.keyhint.fg = moongreyc

# Highlight color for keys to complete the current keychain.
c.colors.keyhint.suffix.fg = moongreyc

# Background color of the keyhint widget.
c.colors.keyhint.bg = moonbg

# Foreground color of an error message.
c.colors.messages.error.fg = moonbg

# Background color of an error message.
c.colors.messages.error.bg = moonred

# Border color of an error message.
c.colors.messages.error.border = moonred

# Foreground color of a warning message.
c.colors.messages.warning.fg = moonbg
...
# Foreground color of an info message.
c.colors.messages.info.fg = moongreyc

# Background color of an info message.
c.colors.messages.info.bg = moonbg

# Border color of an info message.
c.colors.messages.info.border = moonbg

# Foreground color for prompts.
c.colors.prompts.fg = moongreyc

# Border used around UI elements in prompts.
c.colors.prompts.border = moonbg

# Background color for prompts.
c.colors.prompts.bg = moonbg

# Background color for the selected item in filename prompts.
c.colors.prompts.selected.bg = moongreyo

# Foreground color for the selected item in filename prompts.
c.colors.prompts.selected.fg = moongreyc

# Foreground color of the statusbar.
c.colors.statusbar.normal.fg = base0B

# Background color of the statusbar.
c.colors.statusbar.normal.bg = moonbg

# Foreground color of the statusbar in insert mode.
c.colors.statusbar.insert.fg = moonbg

# Background color of the statusbar in insert mode.
c.colors.statusbar.insert.bg = base0D

# Foreground color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.fg = moonbg

# Background color of the statusbar in passthrough mode.
c.colors.statusbar.passthrough.bg = base0C

# Foreground color of the statusbar in private browsing mode.
c.colors.statusbar.private.fg = moonbg

# Background color of the statusbar in private browsing mode.
c.colors.statusbar.private.bg = moongreyo

# Foreground color of the statusbar in command mode.
c.colors.statusbar.command.fg = moongreyc

# Background color of the statusbar in command mode.
c.colors.statusbar.command.bg = moonbg

# Foreground color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.fg = moongreyc

# Background color of the statusbar in private browsing + command mode.
c.colors.statusbar.command.private.bg = moonbg

# Foreground color of the statusbar in caret mode.
c.colors.statusbar.caret.fg = moonbg

# Background color of the statusbar in caret mode.
c.colors.statusbar.caret.bg = base0E

# Foreground color of the statusbar in caret mode with a selection.
c.colors.statusbar.caret.selection.fg = moonbg
...
# Default foreground color of the URL in the statusbar.
c.colors.statusbar.url.fg = moongreyc

# Foreground color of the URL in the statusbar on error.
c.colors.statusbar.url.error.fg = moonred

# Foreground color of the URL in the statusbar for hovered links.
c.colors.statusbar.url.hover.fg = moongreyc
...
# Color for the tab indicator on errors.
c.colors.tabs.indicator.error = moonred

# Foreground color of unselected odd tabs.
c.colors.tabs.odd.fg = moongreyc

# Background color of unselected odd tabs.
c.colors.tabs.odd.bg = moonbg

# Foreground color of unselected even tabs.
c.colors.tabs.even.fg = moongreyc

# Background color of unselected even tabs.
c.colors.tabs.even.bg = moonbg
...
# Background color of pinned selected even tabs.
c.colors.tabs.pinned.selected.even.bg = moongreyo

# Foreground color of pinned selected even tabs.
c.colors.tabs.pinned.selected.even.fg = moongreyc

# Background color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.bg = moongreyo

# Foreground color of pinned selected odd tabs.
c.colors.tabs.pinned.selected.odd.fg = moongreyc

# Foreground color of selected odd tabs.
c.colors.tabs.selected.odd.fg = moongreyc

# Background color of selected odd tabs.
c.colors.tabs.selected.odd.bg = moonbay

# Foreground color of selected even tabs.
c.colors.tabs.selected.even.fg = moongreyc

# Background color of selected even tabs.
c.colors.tabs.selected.even.bg = moonbay

# Background color for webpages if unset (or empty to use the theme's
# color).
# c.colors.webpage.bg = "#000000"
# c.colors.webpage.fg = "#ffffff"
