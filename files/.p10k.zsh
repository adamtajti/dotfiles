# Generated by Powerlevel10k configuration wizard on 2023-01-26 at 23:51 CET.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15312.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 24h time, angled separators, round heads, flat tails, 2 lines, solid, left frame,
# darkest-ornaments, compact, few icons, concise, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_PROMPT_CHAR_OK_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=43
  # Red prompt symbol if the last command failed.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_ERROR_{VIINS,VICMD,VIVIS,VIOWR}_FOREGROUND=196
  # Default prompt symbol.
  typeset -g POWERLEVEL9K_PROMPT_CHAR_{OK,ERROR}_VIINS_CONTENT_EXPANSION='פֿ'
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=49
  ...
  function my_git_formatter() {
    ...
    local      clean='%16F' # black foreground
    local   modified='%16F' # black foreground
    local  untracked='%16F' # black foreground
